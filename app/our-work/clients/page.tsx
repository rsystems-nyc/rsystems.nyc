...
import { mapPoints, worldPoints } from "@/app/lib/clients";
    ...
    <main className="flex-1">
      ...
      <section className="bg-gradient-to-b from-white from-[80%] to-[#F4F2EF]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
          ...
          {/* Column fr units mirror the square NYC map and the world map's
              800x422 viewBox, so both render at identical heights. */}
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-[422fr_800fr] gap-8 items-start">
            <div>
              <p className="text-center text-[11px] font-semibold uppercase tracking-widest text-[#E8500A] mb-3">
                New York City
              </p>
              <NYCMap points={mapPoints} />
            </div>
            <div>
              <p className="text-center text-[11px] font-semibold uppercase tracking-widest text-[#E8500A] mb-3">
                Worldwide
              </p>
              <WorldMap points={worldPoints} />
            </div>
          </div>
        </div>
      </section>
