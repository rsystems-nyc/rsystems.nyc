...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://rsystems.nyc/services/ai/vibe-coding" },
  openGraph: {
    title: "Vibe Coding & Custom Development | RSystems NYC",
    description:
      "RSystems builds custom websites and internal software tools with AI-assisted development — or helps your team do it themselves. We'll build it for you, teach you to do it well, or collaborate — and set up the infrastructure foundation that makes vibe coding work.",
    url: "https://rsystems.nyc/services/ai/vibe-coding",
  },
  twitter: {
    title: "Vibe Coding & Custom Development | RSystems NYC",
    description:
...
const breadcrumbs = breadcrumbSchema([
  ...
  { name: "Vibe Coding & Custom Development", path: "/services/ai/vibe-coding" },
]);
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
          <div className="rounded-xl border border-[#1A1A1A]/[0.07] bg-[#F4F2EF] p-8 lg:p-12">
            ...
            <p className="text-base text-[#1A1A1A]/60 leading-relaxed max-w-2xl mb-8">
              Whether it&apos;s a new website, an internal tool, or the foundation that lets your own
              team vibe code well — let&apos;s figure out the right approach.
            </p>
            <Link
              href="/contact"
