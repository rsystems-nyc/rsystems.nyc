...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://rsystems.nyc/services/technology-consulting/ai-enablement" },
  openGraph: {
    title: "AI Enablement — RSystems NYC",
    description:
      "The right AI models, tools, and workflows for your organization. We help teams adopt AI practically — from first deployment to embedded daily use.",
    url: "https://rsystems.nyc/services/technology-consulting/ai-enablement",
  },
  twitter: {
    title: "AI Enablement — RSystems NYC",
    description:
    ...
    <main className="flex-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <p className="text-base text-[#1A1A1A]/60 leading-relaxed">
                ...
                , and{" "}
                <Link href="/services/technology-consulting/audit-accountability" className="text-[#FE6305] hover:text-[#FE6305]/70 transition-colors">
      ...
      <section className="bg-[#F4F2EF]">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-24">
          ...
          <PageEndCTA pageKey="/services/technology-consulting/ai-enablement" precedingBg="bg-[#F4F2EF]" />
</main>
  );
}
